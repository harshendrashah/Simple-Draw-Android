...
4. **[Clone the repository](https://github.com/harshendrashah/Simple-Draw-Android.git)** from : "https://github.com/harshendrashah/Simple-Draw-Android.git" . 
    
   `bash 
    git clone --recursive https://github.com/harshendrashah/Simple-Draw-Android.git 
    ` 
